...
`nock.is` is an educational project of the [Urbit Systems Technical Journal](https://urbitsystems.tech).

* [𝕏/Twitter](https://x.com/UrbitSTJ)
* [USTJ Forum](https://journal.urbitsystems.tech/forum)

The site is built using [Jupyter Book](https://jupyterbook.org/), an open-source tool for building publication-quality books and documents from computational material.
